...
#Let it ensue
Warn1 = input("WARNING:  THIS IS A WARNING: THIS IS TO BE PUT IN A FOLDER WHERE HAVING EVERY FILE DELETED IS POSSIBLE. THIS IS AN IRREVERSIBLE DELETION. ARE YOU SURE? (Y/N)").strip()
if Warn1.upper() == 'Y':
    Warn2 = input("THIS IS THE FINAL WARNING. THIS IS NOT PART OF THE CHOOSE YOUR OWN ADVENTURE GAME. THIS WILL DELETE ALL FILES IN A FOLDER. WE RECCOMEND PUTTING IN SOME DUMMY FILES FOR FUN. IT IS BETTER, TRUST ME.(Y/N): ").strip()
    if Warn2.upper() == "Y":
        print("Turn off any VPN you have on. You have been warned")
        time.sleep(3)
    else:
        sys.exit(0)
else:
...
while True:
    ...
    if r1.upper() == 'D':
        ...
        if escap.upper() == 'N':
            ...
            print("There goes every file you have")
            time.sleep(3)
